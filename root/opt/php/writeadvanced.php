...
if (isset($_POST['save_settings'])) {
  ...
  if (isset($_POST['smtp_sender'])) {
   $sender = strip_tags($_POST['smtp_sender']);
  }
  else {
   $sender = "";
  }
  ...
  $adv_array['mail'] = array('from' => strip_tags($_POST['from']), 'subject' => strip_tags($_POST['subject']), 'recipients_email' => $recipients_email, 'recipients' => $recipients, 'provider' => $provider, 'sender' => strip_tags($_POST['smtp_sender']), 'address' => $smtp_address, 'port' => $smtp_port, 'username' => strip_tags($_POST['email_username']), 'password' => $_POST['email_password']);
